...
function ExtrairDados(){
  ...
  for(var i1 = 0; i1 < 31 ; i1++){
    var nome = firebase.database().ref("turmas/1BM/aluno" + i1 +"/nome/");
  ...
  for(var i2 = 0; i2 < 31 ; i2++){
    var qntx = firebase.database().ref("turmas/1BM/aluno" + i2 +"/qnt_de_x/");
  ...
  var item3 = "";
  var xNotaDb2 = firebase.database().ref("/turmas/1BM/XpraNota/");
...
function AtualizarDados1(){
  var dados = xNota;
  var updates = {};
  updates['/turmas/1BM/XpraNota/'] = dados;
...
function AtualizarDados2(numero, novoX){
  ...
  var updates = {};
  updates["/turmas/1BM/aluno" + numero + "/qnt_de_x/"] = dados;
  return firebase.database().ref().update(updates);
}
