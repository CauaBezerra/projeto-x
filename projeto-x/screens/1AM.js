...
function ExtrairDados(){
  ...
  for(var i1 = 0; i1 < 31 ; i1++){
    var nome = firebase.database().ref("turmas/1AM/aluno" + i1 +"/nome/");
  ...
  for(var i2 = 0; i2 < 31 ; i2++){
    var qntx = firebase.database().ref("turmas/1AM/aluno" + i2 +"/qnt_de_x/");
  ...
  var item3 = "";
  var xNotaDb2 = firebase.database().ref("/turmas/1AM/XpraNota/");
...
function AtualizarDados1(){
  var dados = xNota;
  var updates = {};
  updates['/turmas/1AM/XpraNota/'] = dados;
...
function AtualizarDados2(numero, novoX){
  ...
  var updates = {};
  updates["/turmas/1AM/aluno" + numero + "/qnt_de_x/"] = dados;
  return firebase.database().ref().update(updates);
}
