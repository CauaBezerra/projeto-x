...
import { Text, View, ScrollView, StyleSheet, Alert, TouchableOpacity, TextInput, Image, RefreshControl} from 'react-native';
...
function FazerLogin (email, senha, navigation){
  if(email == null){
    ...
    .catch((error) => {
      Alert.alert("O email ou a senha não foram inseridos devidamente");
    });
  }
}
  ...
  return(
    <View style={styles.fundo}>
      ...
      <TouchableOpacity style={styles.butao2}
        ...
        <Text style={{fontSize: 20, color: "#33BBFF"}}>Cadastrar-se</Text>
      </TouchableOpacity>
      </ScrollView>
    </View>  
  );
